...
export function TakeItWithYou() {
  return (
    <section className="rise rise-4 mt-16" aria-label="Take it with you" id="take-it-with-you">
      ...
      <p className="mb-6 mt-1 text-[0.95rem] font-light text-parchment-dim">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <div className="panel flex flex-col p-5">
          <p className="smallcaps text-[0.62rem] text-brass">for AI agents · developer preview</p>
          <h3 className="mt-2 font-display text-lg font-semibold text-parchment">
            Wire it into your agent
          </h3>
          <p className="mt-2 flex-1 text-[0.88rem] font-light text-parchment-dim">
          ...
          <pre className="mt-3 overflow-x-auto border border-rule bg-ink-well px-3 py-2 font-mono text-[0.7rem] text-parchment">
            npx -y @axiom-foundation/mcp
          </pre>
          <a
            className="mt-3 font-mono text-[0.72rem] text-brass underline-offset-2 hover:underline"
        ...
        <div className="panel flex flex-col p-5">
          <p className="smallcaps text-[0.62rem] text-brass">for engineers · release pending</p>
          <h3 className="mt-2 font-display text-lg font-semibold text-parchment">
        ...
        <div className="panel flex flex-col p-5">
          <p className="smallcaps text-[0.62rem] text-brass">for domain experts</p>
          <h3 className="mt-2 font-display text-lg font-semibold text-parchment">
